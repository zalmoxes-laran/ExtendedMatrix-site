...
The **EM palette** is a small `.graphml` file that, once imported into
[yEd](https://www.yworks.com/products/yed), adds an *Extended Matrix*
section to yEd's right-hand drag-and-drop panel — with all the typed
nodes (US, USV, USD, SF, DOC, EXT, Property, …) and the standard
connectors.
...
The full walk-through with screenshots is in the
